...
metadata about a Fire Incident in JSON.

## 2. File format

fire-incident manifest files use the JSON format as described in RFC 4627.
...
required, implementations MUST treat the entire IncidentJSON manifest file
